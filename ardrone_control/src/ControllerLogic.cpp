...
ControllerLogic::ControllerLogic(const ros::Publisher& twist_pub, const ros::Publisher& takeoff_pub, const ros::Publisher& land_pub)
{
    ...
    this->kp_approach_wall = 0.9; //0.06;
    this->kd_approach_wall = 0.22; //0.45;
    this->kd_wall_distance = 0.5; //0.35;
    this->kp_tracking_speed = 0; //0.04;
    this->kp_wall_distance = 0.22; //0.06;
    this->kp_angular = 1.5; //0.25;
    this->tracking_speed = 0.2;
