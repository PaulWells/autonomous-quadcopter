...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/catkin_ws/src/hector_quadrotor/hector_quadrotor_model/include;/usr/include".split(';') if "/catkin_ws/src/hector_quadrotor/hector_quadrotor_model/include;/usr/include" != "" else []
